...
import com.vamc.ecommerce.response.PaymentLinkResponse;
...
//		      paymentLinkRequest.put("reference_id",order.getId().toString());
		      ...
		      paymentLinkRequest.put("callback_url","https://shopwithvamc.ecommerce.vercel.app/payment/"+orderId);
...
//			order.setOrderItems(order.getOrderItems());
		...
		new RedirectView("https://shopwithvamc.ecommerce.vercel.app/payment/failed");
		throw new RazorpayException(e.getMessage());
	}
